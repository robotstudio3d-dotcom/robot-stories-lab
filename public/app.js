...
async function execute(exp,fromIndex=0){
 ...
 try{
  ...
  exp.failedStep=exp.runningStep;exp.runningStep=null;exp.lastError=err.message;exp.status="PARTIAL";save(exp);setStatus(`FALLITO ${exp.failedStep}: ${err.message}. Puoi usare RETRY FAILED o RESUME.`);
